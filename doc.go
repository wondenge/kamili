...
1. Type in your shell:
	...
	go get -u github.com/wondenge/kamili/gocomplete
	gocomplete -install
...
So here it is:
	...
	func main() {
		...
		// name must be exactly as the binary that we want to kamili.
		kamili.New("run", run).Run()
	}
